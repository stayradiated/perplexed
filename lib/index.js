...
export default class Client {
  ...
  artists (section, options = {}) {
    ...
    return this.queryWithRange({...options, uri})
      .then((res) => parseArtistContainer(res))
      .then((res) => normalize(res, artistContainerSchema))
  }
  ...
  artist (artistId) {
    const uri = `/library/metadata/${artistId}`
    return this.api.query({uri})
      .then((res) => parseArtistContainer(res))
      .then((res) => normalize(res, artistContainerSchema))
  }
  ...
  artistAlbums (artistId, options = {}) {
    ...
    const uri = `/library/metadata/${artistId}/children?${params}`
